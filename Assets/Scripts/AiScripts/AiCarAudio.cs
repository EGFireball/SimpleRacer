...
namespace UnityStandardAssets.Vehicles.MyCar
{
	...
	public class AiCarAudio : MonoBehaviour
	{
		...
		private float maxCarAcceleration = 5f;
		...
		private void Update()
		{
			...
			if (m_StartedSound)
			{
				...
				else
				{
					...
					float decFade = maxCarAcceleration - accFade;
					...
					accFade = maxCarAcceleration - ((maxCarAcceleration - accFade)*(maxCarAcceleration - accFade));
					decFade = maxCarAcceleration - ((maxCarAcceleration - decFade)*(maxCarAcceleration - decFade));
